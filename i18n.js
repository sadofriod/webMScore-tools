...
const translations = {
  'en': {
    ...
    formatMscx: 'MuseScore Format (MSCX)',
  ...
  'es': {
    ...
    formatMscx: 'Formato MuseScore (MSCX)',
    formatMusicxml: 'MusicXML',
    formatPdf: 'PDF',
    formatMidi: 'MIDI',
    formatMp3: 'MP3',
  ...
  'fr': {
    ...
    formatMscx: 'Format MuseScore (MSCX)',
    formatMusicxml: 'MusicXML',
    formatPdf: 'PDF',
    formatMidi: 'MIDI',
    formatMp3: 'MP3',
  ...
  'ja': {
    ...
    formatMscx: 'MuseScoreフォーマット (MSCX)',
    formatMusicxml: 'MusicXML',
    formatPdf: 'PDF',
    formatMidi: 'MIDI',
    formatMp3: 'MP3',
